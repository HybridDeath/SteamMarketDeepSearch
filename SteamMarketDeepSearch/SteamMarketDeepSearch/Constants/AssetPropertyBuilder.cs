...
namespace SteamMarketDeepSearch.Constants
{
    public static class AssetPropertyBuilder
    {
        ...
        [
            ...
            "CAIVveOUPR0rGJU9",     // 0.0727 > float < 0.728
            "CAIVLjnuOx0Rje47",     // 0.00727 > float < 0.00728
            "CAIVJZQ+Oh1B1z46",     // 0.000727 > float < 0.000728
        ...
        public static IEnumerable<string> BuildSingleAssetProperty()
        {
            foreach (string paint in PaintSeedFilters)
            {
                yield return $"assetproperty={Uri.EscapeDataString(paint)}";
            }
        }
    }
}